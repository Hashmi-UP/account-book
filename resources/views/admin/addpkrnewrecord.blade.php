                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="page-title-box">
                            ...
                            <h4 class="page-title">Add PKR Record</h4>
                        </div>
                        <!--end page-title-box-->
                    </div>
                    <!--end col-->
                ...
                <div class="row">
                    <div class="col-lg-6" style=" margin:auto">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="/addpkrnewrecorddb" method="POST">
                                    @csrf
                        ...
                        <!--Alert End-->
                                    ...
                                    <div class="mb-3">
                                        <label for="exampleInputEmail1">PKR Amount</label>
                                        <input type="number" name="pkr_amount" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter PKR Amount">
                                    </div>
                                    <div class="mb-3">
                                        <label for="exampleInputEmail1">Credit Amount</label>
                                        <input type="number" name="credit_amount" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter PKR Amount">
                                    </div>
                                    <div class="mb-3">
                                        <label for="exampleInputEmail1">PKR Rate</label>
                                        <input type="number" name="pkr_rate" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter PKR Amount" step="any">
                                    </div>
                                    <div class="mb-3">
                                        <label for="exampleInputEmail1">Service Charges</label>
                                        <input type="number" name="ser_chrg" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"  placeholder="Enter Service Charges">
